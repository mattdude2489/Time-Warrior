...
enum e_time			{TIME_SECOND_MS = 1000, TIME_REGEN = TIME_SECOND_MS, TIME_INACTIVE = TIME_SECOND_MS/5, TIME_EXPIRE = TIME_SECOND_MS*5, TIME_WANDER = TIME_SECOND_MS*3, HOURS_HALF_DAY = 12};
enum e_timer		{TIMER_GENERAL, TIMER_REGEN, TIMER_NO_CLICK, NUM_TIMERS};
...
enum e_classType	{HYBRID, CASTER, TANK};
enum e_gender		{GENDER_F, GENDER_M, NUM_GENDERS};
enum e_iconRows		{ICON_ROW_BACKGROUND, ICON_ROW_GENDER, ICON_ROW_CLASS, ICON_ROW_CHIP, ICON_ROW_ATK, ICON_ROW_ARMOR, ICON_ROW_MAGIC, ICON_ROW_WEAPON, ICON_ROW_HEAD, ICON_ROW_TORSO, ICON_ROW_ARM, ICON_ROW_LEG, ICON_ROW_UNLOCK, ICON_ROW_DIVINE, ICON_ROW_THUNDER, ICON_ROW_FIRE, ICON_ROW_ICE, ICON_ROW_BLUNT, ICON_ROW_RANGE, ICON_ROW_SLASH, ICON_ROW_PIERCE, ICON_ROW_POTS, ICON_ROW_POTS_ALT, NUM_ICON_ROWS};
enum e_skillState	{SKILL_LOCKED, SKILL_UNLCKD, SKILL_LV_INC, SKILL_LV_DEC};
enum e_iconBG		{ICON_BG_FILLED, ICON_BG_BORDER, ICON_BG_NONE};
