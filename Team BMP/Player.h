...
enum e_req				{REQ_PLYR_ACCESS_ADV = 3, REQ_PLYR_ACCESS_EXP = REQ_PLYR_ACCESS_ADV*2, REQ_CHIP_BAS_TO_ADV = 10, REQ_CHIP_ADV_TO_EXP = REQ_CHIP_BAS_TO_ADV, REQ_CHIP_BAS_TO_EXP = REQ_CHIP_BAS_TO_ADV+REQ_CHIP_ADV_TO_EXP};
