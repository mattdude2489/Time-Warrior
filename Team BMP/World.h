...
enum e_sprites			{SLIME, SKELETON, GHOST, BOSS1, NPC1, KNIGHT0, KNIGHT1, NUM_SPRITES};
...
enum e_worldTileS		{TILE_BLANK, TILE_METAL_L, TILE_METAL_QUAD_L, TILE_METAL_R, TILE_METAL_QUAD_R, TILE_METAL, TILE_METAL_QUAD, TILE_GRASS, TILE_DUST, TILE_DUST_D, TILE_DUST_R, TILE_DUST_CORNER, TILE_DIRT1, TILE_DIRT2, TILE_SPIKE_LG, TILE_ROCKS, TILE_SPIKE_SM, TILE_DUNGEON_CLOSED, TILE_CASTLE_GROUND, TILE_CASTLE_WALL_V, TILE_CASTLE_WALL_H, TILE_CASTLE_DOOR_L, TILE_CASTLE_DOOR_R, TILE_CASTLE_STAIRS, NUM_WORLD_TILE_S};
...
struct Tile
{
	...
	bool collide, portal, dungeon, spawnLocation, bossLoc, playerSpawn, tree, door, stairs;
	SPoint pos, *cam;
